...
<div id="money_back_guarantee_cont">
    <section id="money_back_guarantee">
        ...
        <p>
            ...
            of your money. <a id="cnrt-link-policy" href="#">Learn more...</a>
        </p>
    </section>
</div>

<div id="cnrt-refund-policy-cont">
    <div id="cnrt-refund-policy" class="cnrt-refund-policy">
        <!-- Modal content -->
        <div id="cnrt-modal-content">
            <span class="cnrt-close-modal-policy" id="cnrt-close-modal-policy">&times;</span>
            <header class="cnrt-modal-header">
                <h2>Refund Policy</h2>
            </header>
...
<div id="cnrt-table-container">
</div>

<div id="cnrt-pricing-faq">
    <div class="cnrt-pricing-faq-row">
    ...
    <div class="cnrt-pricing-faq-row">
        ...
        <p><a href="#" id="cnrt-link-policy-faq">Yes we do!</a> We stand behind the
